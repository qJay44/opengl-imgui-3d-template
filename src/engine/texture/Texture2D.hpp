...
public:
  ...
  static Texture2D image(const image2D& img, const TextureDescriptor& desc, GLsizei level = 0);
  static Texture2D image(const ivec2& size, const TextureDescriptor& desc, GLsizei level = 0);
  static Texture2D image(const fspath& path, const TextureDescriptor& desc, GLsizei level = 0);
